...
var SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
    ...
    value: function create() {
      ...
      header.innerHTML = header.innerHTML + '<div class="sc-actions" style="width:50%"><span class="sc-time"></span></div>';
...
//      }
        ...
        if (data) {
          daysElement.forEach(function (v, i) {
            ...
            if (data[year + '-' + currentmonth + '-' + day]) {
              ...
              v.title = year + '-' + currentmonth + '-' + day;
              console.log(year + '-' + currentmonth + '-' + day)
              v.setAttribute('data-date',year + '-' + currentmonth + '-' + day);
              v.setAttribute('data-adultPrice',data[year + '-' + currentmonth + '-' + day]['adultPrice']);
              v.setAttribute('data-childrenPrice',data[year + '-' + currentmonth + '-' + day]['childrenPrice']);
              v.setAttribute('data-roomPrice',data[year + '-' + currentmonth + '-' + day]['roomPrice']);
              if(data[year + '-' + currentmonth + '-' + day]['insurances']){
              	var insurances=data[year + '-' + currentmonth + '-' + day]['insurances'];
              	v.setAttribute('data-insurances',JSON.stringify(insurances));
              }
              //v.name = year + '-' + currentmonth + '-' + day;
              daysElement[i].querySelector('.lunar-day').innerHTML = "￥"+data[year + '-' + currentmonth + '-' + day]['adultPrice'];
    ...
    value: function updateEvent() {
      var daysElement = this.arrayfrom(this.container.querySelectorAll('.sc-mark'));
      ...
      daysElement.forEach(function (v, i) {
        ...
        v.onclick = function (e) {
          ...
          //console.log(v.getAttribute('data-date'));
          ...
          //加载出行人数以及相关信息
          var adultPrice=v.getAttribute('data-adultPrice');
          var childrenPrice=v.getAttribute('data-childrenPrice');
          var roomPrice=v.getAttribute('data-roomPrice');
          var insurances=v.getAttribute('data-insurances'); 
          var date1=v.getAttribute('data-date'); 
          loadCartData(date1,adultPrice,childrenPrice,roomPrice,insurances)
        };
      });
